...
namespace Zork
{
    ...
    class Program
    {
        ...
        private static void InitializeRoomDescription()
        {
            ...
            Rooms[0, 2].Description = "You are at the top of the Great Conyon on its south wall";                                                 //Canyon View
            ...
            Rooms[2, 1].Description = "You are faccing the north side of a white house. There is no door here, and all the windows are barred.";   //North of House
